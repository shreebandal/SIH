...
require_once 'function.php';
  ...
  if(isset($_GET['eid']) AND isset($_GET['token']) AND isset($_GET['exd'])){
    ...
    if($current_date >= $expire_date){
      ...
      $query1 = "SELECT * FROM alumni where email='$email' AND validation_key='$validation_key' AND is_active = 1";
      ...
      if($row_num==1){
        ...
        //Query
        $query = "UPDATE alumni SET is_active=1 where email='$email' AND validation_key = '$validation_key'";
